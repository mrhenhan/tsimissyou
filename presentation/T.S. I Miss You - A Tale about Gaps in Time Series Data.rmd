...
- ## Most ready to use solutions address multivariate time series!
---
# Samples
.pull-left[
.center[Airline Passengers - Trend + seasonality]
```{r out.width='100%', fig.height=3, eval=require('TSA'), echo=FALSE}
  data(list = 'airpass')
...
- ## Identify patterns through decomposition
- ## Gaps could be in distinct parts
- ## Helps with selection of imputation method
which python
???
...
# Trend,Seasonality
.pull-left[
.center[Air Passengers]
```{r eval=require('TSA'), echo=FALSE}
  library(ggplot2)
  library(ggfortify)
  data(list = 'airpass')
  autoplot(airpass)
...
## $P(r|Y_{observed}, Y_{missing}) = P(r)$
...
## $P(r|Y_{observed}, Y_{missing}) = P(r|Y_{observed})$
...
## $P(r|Y_{observed}, Y_{missing}) = P(r|Y_{observed}, Y_{missing})$
